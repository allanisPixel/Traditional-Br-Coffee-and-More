...
package net.mcreator.tbcm.block;
...
public class BlockCoofeePlant extends ElementsTbcmMod.ModElement {
	@GameRegistry.ObjectHolder("tbcm:coofee_plant")
	public static final Block block = null;
	public BlockCoofeePlant(ElementsTbcmMod instance) {
		super(instance, 10);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tbcm:coofee_plant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("coofee_plant");
			setRegistryName("coofee_plant");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCoffeeSeeds.block, (int) (3)));
		}

		@Override
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemCoffeeSeeds.block, (int) (1));
		}
