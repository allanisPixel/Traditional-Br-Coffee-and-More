...
public class ItemCoffeeBeans extends ElementsTbcmMod.ModElement {
	@GameRegistry.ObjectHolder("tbcm:coffee_beans")
	public static final Item block = null;
	public ItemCoffeeBeans(ElementsTbcmMod instance) {
		super(instance, 4);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("tbcm:coffee_beans", "inventory"));
	}
